...
const camry = new Car ("Toyota","Camry",2020,true)
console.log({camry})
camry.toggleAvailability()
console.log({camry})
...
// ● renterName (string): The name of the person who rented the car. ● rentalStartDate (Date object): The start date of the rental period. 
...
class Rental {
  ...
  const mazda = new Car("Mazda", "CX5", 2016, false);

  
  const rental1 = new Rental(toyota, "Muhadi", new Date("2023-11-01"), new Date("2023-11-12"));
const rental2 = new Rental(mazda, "Wawire", new Date("2023-08-10"), new Date("2023-010-12"));

console.log(rental1.calculateRentalDuration()); 
console.log(rental2.calculateRentalDuration());

//3) Create an instance of the Car class or function constructor for a car in the inventory. Then, create an instance of the Rental class 
//or function constructor for a rental involving the car you created. Finally, calculate the rental duration using the calculateRentalDuration method.

const probox = new Car("Nissan", "CF5", 2020, true);
const rental = new Rental("Discovery", "Reign", new Date("2023-01-01"), new Date("2023-02-01"));
const rentalDuration = rental.calculateRentalDuration();
console.log("Rental Duration:", rentalDuration, "days");


// You are building a simple quiz app that contains multiple-choice questions. Your task is to create two JavaScript classes: Question and Quiz. The Question class will 
// represent individual questions, and the Quiz class will manage a collection of questions and the user's progress. 
...
const question1 = new Question(
  "How many patners should someone have?",
  ["One","Eight","Four","Five"],
  "One"
);
